function varargout = larvalign_GUI(varargin)
% larvalign_GUI MATLAB code for larvalign_GUI.fig
%      larvalign_GUI, by itself, creates a new larvalign_GUI or raises the existing
%      singleton*.
%
%      H = larvalign_GUI returns the handle to a new larvalign_GUI or the handle to
%      the existing singleton*.
%
%      larvalign_GUI('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in larvalign_GUI.M with the given input arguments.
%
%      larvalign_GUI('Property','Value',...) creates a new larvalign_GUI or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before larvalign_GUI_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to larvalign_GUI_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help larvalign_GUI

% Last Modified by GUIDE v2.5 27-Jan-2017 16:05:00
...
% --- Executes just before larvalign_GUI is made visible.
function larvalign_GUI_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to larvalign_GUI (see VARARGIN)

% Choose default command line output for larvalign_GUI
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes larvalign_GUI wait for user response (see UIRESUME)
...
% handles    structure with handles and user data (see GUIDATA)
folder_name = uigetdir;
set(handles.edit7, 'String', folder_name );
...
% handles    structure with handles and user data (see GUIDATA)
folder_name = uigetdir;
set(handles.edit13, 'String', folder_name );
