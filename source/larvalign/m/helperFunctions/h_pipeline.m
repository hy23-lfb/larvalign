...
function msg = h_pipeline()
    ...
    fixed_images = ["'B3'","'B4'","'B5'", "'B6'","'B4_Flip'","'B5_Flip'", "'B6_Flip'", "'B3_Flip'", "'B7'", "'B7_Flip'", "'B3'"];
    fixed_cp = ["B3","B4","B5", "B6","B4_Flip","B5_Flip", "B6_Flip", "B3_Flip", "B7", "B7_Flip", "B3"];
    ...
    for i=1:cf-1
        ...
        if(i==1) %B4
            moving_files = ["'B3'", "'B5'", "'B6'", "'B3_Flip'", "'B4_Flip'", "'B5_Flip'", "'B6_Flip'", "'B7'", "'B7_Flip'"];
            moving_cp = ["B3", "B5", "B6", "B3_Flip", "B4_Flip", "B5_Flip", "B6_Flip", "B7", "B7_Flip"];
        elseif(i==2) %B5
            moving_files = ["'B3'", "'B4'", "'B6'", "'B3_Flip'", "'B4_Flip'", "'B5_Flip'", "'B6_Flip'", "'B7'", "'B7_Flip'"];
            moving_cp = ["B3", "B4","B6", "B3_Flip", "B4_Flip", "B5_Flip", "B6_Flip", "B7", "B7_Flip"];
        elseif(i==3) %B6
            moving_files = ["'B3'", "'B4'", "'B5'", "'B3_Flip'", "'B4_Flip'", "'B5_Flip'", "'B6_Flip'", "'B7'", "'B7_Flip'"];
            moving_cp = ["B3", "B4", "B5", "B3_Flip", "B4_Flip", "B5_Flip", "B6_Flip", "B7", "B7_Flip"];
        elseif(i==4) %B4_Flip
            moving_files = ["'B3'", "'B4'", "'B5'", "'B6'", "'B3_Flip'", "'B5_Flip'", "'B6_Flip'", "'B7'", "'B7_Flip'"];
            moving_cp = ["B3", "B4", "B5","B6", "B3_Flip", "B5_Flip", "B6_Flip", "B7", "B7_Flip"];
        elseif(i==5) %B5_Flip
            moving_files = ["'B3'", "'B4'", "'B5'", "'B6'", "'B3_Flip'", "'B4_Flip'", "'B6_Flip'", "'B7'", "'B7_Flip'"];
            moving_cp = ["B3", "B4", "B5","B6", "B3_Flip", "B4_Flip", "B6_Flip", "B7", "B7_Flip"];
        elseif(i==6) %B6_Flip
            moving_files = ["'B3'", "'B4'", "'B5'", "'B6'", "'B3_Flip'", "'B4_Flip'", "'B5_Flip'", "'B7'", "'B7_Flip'"];
            moving_cp = ["B3", "B4", "B5","B6", "B3_Flip", "B4_Flip", "B5_Flip", "B7", "B7_Flip"];
        elseif(i==7) %B3_Flip
            moving_files = ["'B3'", "'B4'", "'B5'", "'B6'", "'B4_Flip'", "'B5_Flip'", "'B6_Flip'", "'B7'", "'B7_Flip'"];
            moving_cp = ["B3", "B4", "B5","B6", "B4_Flip", "B5_Flip", "B6_Flip", "B7", "B7_Flip"];
        elseif(i==8) %B7
            moving_files = ["'B3'", "'B4'", "'B5'", "'B6'", "'B3_Flip'", "'B4_Flip'", "'B5_Flip'", "'B6_Flip'", "'B7_Flip'"];
            moving_cp = ["B3", "B4", "B5","B6", "B3_Flip", "B4_Flip", "B5_Flip", "B6_Flip", "B7_Flip"];
        elseif(i==9) %B7_Flip
            moving_files = ["'B3'", "'B4'", "'B5'", "'B6'", "'B7'", "'B3_Flip'", "'B4_Flip'", "'B5_Flip'", "'B6_Flip'"];
            moving_cp = ["B3", "B4", "B5", "B6", "B7", "B3_Flip", "B4_Flip", "B5_Flip", "B6_Flip"];
        elseif(i==10) %B3
            moving_files = ["'B4'", "'B5'", "'B6'", "'B3_Flip'", "'B4_Flip'", "'B5_Flip'", "'B6_Flip'", "'B7'", "'B7_Flip'"];
            moving_cp = ["B4", "B5","B6", "B3_Flip", "B4_Flip", "B5_Flip", "B6_Flip", "B7", "B7_Flip"];
        else
        ...
        for j=1:cm % for a given template register all possible moving images.
            ...
            fprintf("\n\nThe template image GenerateTransform PP is %s\n", template{idxT,1});
            ...
            msg = larvalignMain();
            t = toc;
            logstr = [datestr(datetime) sprintf(' -- Larvalign for took: %g s', t)];
            fprintf([logstr '\n\n']);
            ...
            out_suffix = 'D:\Harsha\Files_Hiwi\Output\RegisteredScans\NP\';
            out_file = [out_suffix move '.*'];
            copyfile(out_file, dst_dir);
            %fprintf("out_file, dst_dir: %s, %s\n", out_file, dst_dir);
